...
?>
<div id="div1">
<form action="index.php?r=tests/search" method="post">
<input type="text" id="sou" ><input type="button" class="button" value="搜索">
</form>
...
$(document).on("click",".button",function(){
	name=$("#sou").val()
	//alert(name);
	$.get("index.php?r=tests/search&name="+name,function(data){
		$("#div1").html(data);
	})
})
